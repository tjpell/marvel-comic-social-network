...
```{r}
el <- read.csv("~/marvel-comic-social-network/data/weighted_edge_top_1000.csv") 
...
This shows us that the maximum Marvel Number (for our main connected component) is 5, meaning that someone knows someone who ... who knows Ant Man.
